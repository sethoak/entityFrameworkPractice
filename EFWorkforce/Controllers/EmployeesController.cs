...
namespace EFWorkforce.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,DepartmentId,Email,IsSupervisor,ComputerId")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,DepartmentId,Email,IsSupervisor,ComputerId")] Employee employee)
        {
            if (id != employee.Id)
            {
                return NotFound();
